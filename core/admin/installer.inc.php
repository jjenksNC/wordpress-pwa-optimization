                    ...
                    case "pagecache":
                        ...
                        $cache_plugins = array(
                            array(
                                ...
                                'desc' => 'Advanced file based page cache with PHP Opcache boost option (<a href="https://medium.com/@Gu55/love-the-blazing-speed-b9a90a70c192" target="_blank">500x faster than Redis and Memcached</a>).',
...
?>
			...
			<p class="about-text" style="margin-top:0px;min-height:inherit;">The following Page Cache plugins are available as part of the WPO plugin collection.</p>
                    ...
                    case "tools":
                        ...
                        $cache_plugins = array(
                            array(
                                ...
                                'desc' => '.htaccess editor for optimization purposes.',
                                'github' => 'https://github.com/o10n-x/wordpress-htaccess-editor'
                            ),
                            array(
                                'title' => 'Nginx config editor',
                                'desc' => 'Nginx config editor for optimization purposes.',
                                'github' => 'https://github.com/o10n-x/wordpress-nginx-editor'
                            )
                        );
?>
			<h1><strong>Optimization Tools</strong></h1>

			<div style="float:right; margin-right:10px;">
				<a href="https://github.com/afragen/github-updater" target="_blank" rel="noopener"><img src="<?php print O10N_CORE_URI; ?>admin/images/github-updater.png" alt="Github Updater" width="180" border="0" style="float:right;"></a>
			</div>

			<p class="about-text" style="margin-top:0px;min-height:inherit;">The following optimization tools are available as part of the WPO plugin collection.</p>
...
<?php if (isset($plugin['desc'])) {
                        ?><p class="about-text" style="min-height:inherit;margin-top:0px;margin-bottom:10px;"><?php print $plugin['desc']; ?></p><?php
                    } ?>
<input type="hidden" name="option_page" value="github_updater_install">
<input type="hidden" name="action" value="update">
<input type="hidden" name="github_updater_branch" value="">
